      ...
      <div className='flex justify-between  max-w-[1180px] w-full m-auto '>
        <div className='flex justify-between flex-col	h-[480px] '>
          <div className=' flex justify-between flex-col'>
            ...
            <hr  className='bg-[#758499] w-[80px] h-[4px]	 border-solid	'/>
          </div>
          <div>
            <p className='text-7xl font-Noto ' >Zakaria Hamdino</p>
        ...
        <div className='top-0 right-0 absolute w-full max-w-[1180px] h-full'>
            <img src={profilepic} className='top-[160px] z-10 right-20 absolute w-[450px]  ' alt='profile picture of the person'/>
            <img className='absolute top-[-15px] w-[900px] right-[-250px] ' src={backgroundpicture} alt='profile picture of the person'/>
        </div>
        </div>
      </div>
    </div>
