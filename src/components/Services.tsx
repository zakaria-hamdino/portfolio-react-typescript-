...
const Services = () => {
  return (
    <div className='pt-10 bg-[#F6F8FA] px-[200px]'>
        <div>
            ...
            <div className='flex justify-between '>
                ...
                <img src={fleche} className="w-[90px]" /> 
            </div>
        </div>
        <div className='flex justify-between pt-5'>
            <div className='flex '>
                <img src={design} className='w-[20px] h-[20px]' />
            ...
            <div className='flex '>
                <img src={development} className='w-[20px] h-[20px]' />
                <div className='flex justify-between flex-col  h-[150px] w-[240px] pl-[15px] '>
